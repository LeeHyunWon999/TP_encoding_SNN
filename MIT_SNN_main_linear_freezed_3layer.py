...
writer = SummaryWriter(log_dir="./tensorboard/"+ str(model_name) + "_" + board_class + "_encoders" + str(num_encoders) + "_early" + str(early_stop) + "_lr" + str(learning_rate))
...
model.encoders[0].weight = nn.Parameter(manual_weights, requires_grad=False) # 가중치 고정!
